...
const Footer = () => {
  return (
    <div className="footer  flex flex-col  px-[10px] lg:px-[130px] py-[30px] lg:py-[60px]">
      <div className="flex items-center">
        <div className="w-[50%] flex flex-col gap-[32px]">
          <ul className="grid grid-cols-2 gap-[20px] w-[200px]">
            <li>Home</li>
            <li>Contact Us</li>
            <li>About Us</li>
            <li>Community</li>
        ...
        <div className="w-[50%] flex flex-col lg:flex-row gap-[20px]">
          <input
            type="email"
            name="email"
            id="email"
